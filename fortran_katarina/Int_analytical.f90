...
SUBROUTINE Analytical_int(xb,pb,xbar,N,L11,L12,L13,L14,L22,L23,L24,DEBUG)
 ...
 IF (DEBUG == 1) THEN
    PRINT '(*(F32.16))', xbar(1),xbar(2),xbar(3)
    PRINT '(*(F32.16))', xb(1),xb(2),xb(3)
    PRINT '(*(F32.16))', R_0(1),R_0(2),R_0(3)
    PRINT '(*(F32.16))', b
    PRINT '(*(F32.16))', c
    PRINT '(*(F32.16))', d
 END IF
  ...
  IF (c<clim) THEN
     ...
     DO ii=3,N+3
      ...
      !  IF (DEBUG == 1) THEN
      !     PRINT '(*(F32.16))', REAL(ii), REAL(N), I(ii)
      !  END IF
  ...
  END IF
  IF (DEBUG == 1) THEN
     PRINT '(*(F32.16))', REAL(1), S(1)
     PRINT '(*(F32.16))', REAL(2), S(2)
  END IF
  ...
  IF (c<clim) THEN
     DO ii=3,N+3
        ...
        IF (DEBUG == 1) THEN
           PRINT '(*(F32.16))', REAL(ii), REAL(N), S(ii)
        END IF
...
END IF
 ...
 IF (DEBUG == 1) THEN
    PRINT '(*(F16.6))', I(1),I(2),I(3),I(4),I(5),I(6),I(7),I(8)
    PRINT '(*(F16.6))', J(1),J(2),J(3),J(4),J(5),J(6),J(7),J(8)
    PRINT '(*(F16.6))', S(1),S(2),S(3),S(4),S(5),S(6),S(7),S(8)
 END IF
...
DO ii=1,N+1
  ...
  ELSEIF (ii==6) THEN
   ...
   IF (DEBUG == 1) THEN
      ...
      PRINT '(*(F16.6))', real(ii), I(ii), I(ii-2), I(ii-4)
      PRINT '(*(F16.6))', real(ii), 0.125d0*63.0d0*I(ii)-0.125d0*70.0d0*I(ii-2)+0.125d0*15.0d0*I(ii-4)
      PRINT '(*(F16.6))', real(ii), 0.125d0*(63.0d0*I(ii)-70.0d0*I(ii-2)+15.0d0*I(ii-4))
   END IF
  ELSEIF (ii==7) THEN
