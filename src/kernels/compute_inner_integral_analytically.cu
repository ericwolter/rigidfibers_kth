     ...
     const bool debug)
{
    ...
    for (int quadrature_index_i = 0; quadrature_index_i < TOTAL_NUMBER_OF_QUADRATURE_POINTS; ++quadrature_index_i)
    {
        ...
        //     printf(" %.16f\n", 0, logf(fabs(2.0f * s_upper + b + 2.0f * u_upper)));
        // }
        ...
        {
            L01 = 0.125 * (35.0f * I1[k] - 30.0f * I1[k - 2] + 3.0f * I1[k - 4]);
            L03 = 0.125 * (35.0f * I3[k] - 30.0f * I3[k - 2] + 3.0f * I3[k - 4]);
            L05 = 0.125 * (35.0f * I5[k] - 30.0f * I5[k - 2] + 3.0f * I5[k - 4]);
            L13 = 0.125 * (35.0f * I3[k + 1] - 30.0f * I3[k - 1] + 3.0f * I3[k - 3]);
            L15 = 0.125 * (35.0f * I5[k + 1] - 30.0f * I5[k - 1] + 3.0f * I5[k - 3]);
            L23 = 0.125 * (35.0f * I3[k + 2] - 30.0f * I3[k] + 3.0f * I3[k - 2]);
            L25 = 0.125 * (35.0f * I5[k + 2] - 30.0f * I5[k] + 3.0f * I5[k - 2]);
        }
        else if (k == 5)
        {
            L01 = 0.125 * (63.0f * I1[k] - 70.0f * I1[k - 2] + 15.0f * I1[k - 4]);
            L03 = 0.125 * (63.0f * I3[k] - 70.0f * I3[k - 2] + 15.0f * I3[k - 4]);
            L05 = 0.125 * (63.0f * I5[k] - 70.0f * I5[k - 2] + 15.0f * I5[k - 4]);
            L13 = 0.125 * (63.0f * I3[k + 1] - 70.0f * I3[k - 1] + 15.0f * I3[k - 3]);
            L15 = 0.125 * (63.0f * I5[k + 1] - 70.0f * I5[k - 1] + 15.0f * I5[k - 3]);
            L23 = 0.125 * (63.0f * I3[k + 2] - 70.0f * I3[k] + 15.0f * I3[k - 2]);
            L25 = 0.125 * (63.0f * I5[k + 2] - 70.0f * I5[k] + 15.0f * I5[k - 2]);
        }
        else if (k == 6)
        {
            L01 = 0.0625 * (231.0f * I1[k] - 315.0f * I1[k - 2] + 105.0f * I1[k - 4] - 5.0f * I1[k - 6]);
            L03 = 0.0625 * (231.0f * I3[k] - 315.0f * I3[k - 2] + 105.0f * I3[k - 4] - 5.0f * I3[k - 6]);
            L05 = 0.0625 * (231.0f * I5[k] - 315.0f * I5[k - 2] + 105.0f * I5[k - 4] - 5.0f * I5[k - 6]);
            L13 = 0.0625 * (231.0f * I3[k + 1] - 315.0f * I3[k - 1] + 105.0f * I3[k - 3] - 5.0f * I3[k - 5]);
            L15 = 0.0625 * (231.0f * I5[k + 1] - 315.0f * I5[k - 1] + 105.0f * I5[k - 3] - 5.0f * I5[k - 5]);
            L23 = 0.0625 * (231.0f * I3[k + 2] - 315.0f * I3[k] + 105.0f * I3[k - 2] - 5.0f * I3[k - 4]);
            L25 = 0.0625 * (231.0f * I5[k + 2] - 315.0f * I5[k] + 105.0f * I5[k - 2] - 5.0f * I5[k - 4]);
        }
        else if (k == 7)
        {
            L01 = 0.0625 * (429.0f * I1[k] - 693.0f * I1[k - 2] + 315.0f * I1[k - 4] - 35.0f * I1[k - 6]);
            L03 = 0.0625 * (429.0f * I3[k] - 693.0f * I3[k - 2] + 315.0f * I3[k - 4] - 35.0f * I3[k - 6]);
            L05 = 0.0625 * (429.0f * I5[k] - 693.0f * I5[k - 2] + 315.0f * I5[k - 4] - 35.0f * I5[k - 6]);
            L13 = 0.0625 * (429.0f * I3[k + 1] - 693.0f * I3[k - 1] + 315.0f * I3[k - 3] - 35.0f * I3[k - 5]);
            L15 = 0.0625 * (429.0f * I5[k + 1] - 693.0f * I5[k - 1] + 315.0f * I5[k - 3] - 35.0f * I5[k - 5]);
            L23 = 0.0625 * (429.0f * I3[k + 2] - 693.0f * I3[k] + 315.0f * I3[k - 2] - 35.0f * I3[k - 4]);
            L25 = 0.0625 * (429.0f * I5[k + 2] - 693.0f * I5[k] + 315.0f * I5[k - 2] - 35.0f * I5[k - 4]);
        }
        else if (k == 8)
        {
            L01 = 0.0078125 * (6435.0f * I1[k] - 12012.0f * I1[k - 2] + 6930.0f * I1[k - 4] - 1260.0f * I1[k - 6] + 35.0f * I1[k - 8]);
            L03 = 0.0078125 * (6435.0f * I3[k] - 12012.0f * I3[k - 2] + 6930.0f * I3[k - 4] - 1260.0f * I3[k - 6] + 35.0f * I3[k - 8]);
            L05 = 0.0078125 * (6435.0f * I5[k] - 12012.0f * I5[k - 2] + 6930.0f * I5[k - 4] - 1260.0f * I5[k - 6] + 35.0f * I5[k - 8]);
            L13 = 0.0078125 * (6435.0f * I3[k + 1] - 12012.0f * I3[k - 1] + 6930.0f * I3[k - 3] - 1260.0f * I3[k - 5] + 35.0f * I3[k - 7]);
            L15 = 0.0078125 * (6435.0f * I5[k + 1] - 12012.0f * I5[k - 1] + 6930.0f * I5[k - 3] - 1260.0f * I5[k - 5] + 35.0f * I5[k - 7]);
            L23 = 0.0078125 * (6435.0f * I3[k + 2] - 12012.0f * I3[k] + 6930.0f * I3[k - 2] - 1260.0f * I3[k - 4] + 35.0f * I3[k - 6]);
            L25 = 0.0078125 * (6435.0f * I5[k + 2] - 12012.0f * I5[k] + 6930.0f * I5[k - 2] - 1260.0f * I5[k - 4] + 35.0f * I5[k - 6]);
        }
        ...
        //             c,
        //             logf(fabs(2.0f * s_upper + b + 2.0f * u_upper)),
        //            I1[0],
        //            I1[1],
        //            I1[2],
        //            I1[3],
