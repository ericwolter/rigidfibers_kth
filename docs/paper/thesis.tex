...
\begin{equation}
	...
	\mathbf{G}(\mathbf{R} = \left\{
		\begin{array}{lr}
			\mathbf{S}(\mathbf{R}) + \frac{r^2}{2}\mathbf{D}(\mathbf{R}) & \text{if} l \neq m \\
			0 & \text{if} l = m
		\end{array}
	\right,
\end{equation}
