...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \addplot[set11,mark=*,mark options={fill=white}, very thick] table[x=X,y expr=\thisrow{$TOTAL} * 0.125] {benchmarks/steps_fortran.csv};
    \addplot[set12,mark=*,mark options={fill=white}, very thick] table[x=X,y=$TOTAL]  {benchmarks/steps_2D_gmres.csv};
    \addplot[set13,mark=*,mark options={fill=white}, very thick] table[x=X,y=$TOTAL]  {benchmarks/steps_2D_bicgstab.csv};
    \addplot[set14,mark=*,mark options={fill=white}, very thick] table[x=X,y=$TOTAL]  {benchmarks/steps_2D_magma.csv};
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \setmathfont{FiraSans-Book.otf}
    \pgfplotstableread{benchmarks/steps_2D_magma.csv}\loadedtable
    \begin{axis}[
      stack plots=y,
      area style,
      title=Steps (CUDA),
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \addplot[color=set12,mark=*,mark options={fill=white}, very thick] table[x=X,y=solve_system] {benchmarks/steps_2D_magma.csv};
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \addplot[color=set13,mark=*,mark options={fill=white}, very thick] table[x=X,y=assemble_system] {benchmarks/steps_2D_magma.csv};
