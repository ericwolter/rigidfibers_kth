...
We now look at the performance results for the different optimizations previously outlined in Sec.~\ref{sec:parallel_optimizations}. Where applicable, the results will be compared between the OpenMP and the CUDA version of the algorithm.
...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption[Benchmark computing inner integral on CPU.]{Benchmark comparing numerical and analytical integration of inner integral (Eqn.~\eqref{eq:inner_integral} using OpenMP.}
...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption[Benchmark computing inner integral on GPU.]{Benchmark comparing numerical and analytical integration of inner integral (Eqn.~\eqref{eq:inner_integral}) using CUDA.}
