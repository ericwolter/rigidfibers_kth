...
For these reasons and in order to have a fairer comparison of the performance differences between the GPU and CPU implementation, a completely new and rewritten parallel CPU code was also implemented. For the parallelization on the CPU the OpenMP library,~\cite{OpenMP}, was chosen.
