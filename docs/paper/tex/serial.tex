...
Using the force expansion from Eqn.~\eqref{eq:force_discretization} in Eqn.~\eqref{} we get a closed linear system of equations for the coefficients $a_{m}^{n}$ for $n=1,\dots,N$ force expansions and $m = 1,\dots,M$ fibers.
