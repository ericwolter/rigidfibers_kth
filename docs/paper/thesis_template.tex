...
\pgfplotsset{width=\textwidth,compat=1.11} % avoid running in backwards compatibility mode
...
\chapter{Review of Naviar Stokes Equations}
...
\chapter{State of the Art in Fibers}
...
\chapter{Parallization of Rigid Fibers Simulation}
