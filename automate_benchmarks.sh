...
#cp -f results.csv benchmarks/openmp_direct_numerical.csv

#rm -f results.csv
#./fibers_runner.py fortran benchmark --direct --analytical tests/config.ini
#cp -f results.csv benchmarks/openmp_direct_analytical.csv

# GMRES
# -------------
#rm -f results.csv
#./fibers_runner.py fortran benchmark --gmres --numerical tests/config.ini
#cp -f results.csv benchmarks/openmp_gmres_numerical.csv

#rm -f results.csv
#./fibers_runner.py fortran benchmark --gmres --analytical tests/config.ini
#cp -f results.csv benchmarks/openmp_gmres_analytical.csv
